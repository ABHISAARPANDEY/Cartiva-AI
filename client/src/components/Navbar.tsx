...
import { Bot, Menu, X, ChevronDown, ShoppingCart, Building2, Landmark, HeartPulse } from "lucide-react";
import { useState } from "react";
import { Sheet, SheetContent, SheetTrigger } from "@/components/ui/sheet";

const industries = [
  { name: "E-commerce", href: "/industries/ecommerce", icon: <ShoppingCart className="w-4 h-4" />, color: "text-blue-600" },
  { name: "Real Estate", href: "/industries/real-estate", icon: <Building2 className="w-4 h-4" />, color: "text-emerald-600" },
  { name: "Finance", href: "/industries/finance", icon: <Landmark className="w-4 h-4" />, color: "text-violet-600" },
  { name: "Healthcare", href: "/industries/healthcare", icon: <HeartPulse className="w-4 h-4" />, color: "text-rose-600" },
];
          ...
          <Sheet open={isOpen} onOpenChange={setIsOpen}>
            ...
            <SheetContent side="right">
              <div className="flex flex-col gap-4 mt-8">
                <Link href="/#features" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors py-2">Features</Link>
                <Link href="/how-it-works" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors py-2">How it Works</Link>
                ...
                <Link href="/integrations" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors py-2">Integrations</Link>
                <Link href="/pricing" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors py-2">Pricing</Link>
